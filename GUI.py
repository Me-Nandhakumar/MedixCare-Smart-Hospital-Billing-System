...
def open_appointment_window():
    ...
    labels = ["Patient Name", "Doctor", "Date (YYYY-MM-DD)", "Time (e.g. 10:30 AM)"]
    entries = []
...
t.Button(dg, text="Appointments", font=("Arial bold", 16), command=open_appointment_window).pack(pady=10)
